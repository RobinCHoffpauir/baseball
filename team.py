...
class team:
    ...
    def get_schedule():
        rockies = pyb.sch(year, 'COL')
        giants = pyb.sch(year, 'SFG')
        dodgers = pyb.sch(year, 'LAD')
        white_sox = pyb.sch(year, 'CHW')
        astros = pyb.sch(year, 'HOU')
        brewers = pyb.sch(year, 'MIL')
        rays = pyb.sch(year, 'TBR')
        red_sox = pyb.sch(year, 'BOS')
        d_backs = pyb.sch(year, 'ARI')
        tigers = pyb.sch(year, 'DET')
        guardians = pyb.sch(year, 'CLE')
        twins = pyb.sch(year, 'MIN')
        tigers = pyb.sch(year, 'KCA')
        reds = pyb.sch(year, 'CIN')
        orioles = pyb.sch(year, 'BAL')
        blue_jays = pyb.sch(year, 'TOR')
        nationals = pyb.sch(year, 'WSN')
        angels = pyb.sch(year, 'LAA')
        rangers = pyb.sch(year, 'TEX')
        athletics = pyb.sch(year, 'OAK')
        mariners = pyb.sch(year, 'SEA')
        cubs = pyb.sch(year, 'CHC')
        royals = pyb.sch(year, 'KCR')
